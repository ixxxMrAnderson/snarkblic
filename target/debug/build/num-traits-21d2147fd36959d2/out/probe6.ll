; ModuleID = 'probe6.10828472bf419e7e-cgu.0'
source_filename = "probe6.10828472bf419e7e-cgu.0"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h62a0a68b5981b0fbE"(double %self) unnamed_addr #0 {
start:
...
define void @_ZN6probe65probe17hfffa949758ae34a3E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h62a0a68b5981b0fbE"(double 1.000000e+00)
  ret void
}
